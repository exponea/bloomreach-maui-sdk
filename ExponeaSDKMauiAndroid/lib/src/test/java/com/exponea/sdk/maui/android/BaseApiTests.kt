...
class BaseApiTests {
    ...
    private lateinit var instance: ExponeaSDK
    ...
    private val mauiTestJsonDir = File("../../ExponeaTests/Jsons")
    ...
    fun beforeTest() {
        ...
        every { Exponea.identifyCustomer(any(), any()) } just Runs
        instance = ExponeaSDK(ApplicationProvider.getApplicationContext())
    }
