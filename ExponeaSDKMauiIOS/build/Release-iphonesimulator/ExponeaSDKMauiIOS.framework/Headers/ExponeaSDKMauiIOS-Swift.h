...
#ifndef EXPONEASDKMAUIIOS_SWIFT_H
#define EXPONEASDKMAUIIOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ExponeaSDKMauiIOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("ExponeaMauiVersion")
@interface ExponeaMauiVersion : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class MethodResult;
@class MethodResultForUI;
...
SWIFT_CLASS_NAMED("MauiAuthorizationProvider")
@interface MauiAuthorizationProvider : NSObject <AuthorizationProviderType>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (NSString * _Nullable)getAuthorizationToken SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS_NAMED("MethodResult")
...
SWIFT_CLASS_NAMED("MethodResultForUI")
@interface MethodResultForUI : NSObject
@property (nonatomic, readonly) BOOL success;
@property (nonatomic, readonly, strong) UIView * _Nullable data;
@property (nonatomic, readonly, copy) NSString * _Nonnull error;
- (nonnull instancetype)initWithSuccess:(BOOL)success data:(UIView * _Nullable)data error:(NSString * _Nonnull)error OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
