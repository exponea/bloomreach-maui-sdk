...
#xcodebuild -sdk iphonesimulator -workspace "$SWIFT_PROJECT_NAME.xcworkspace" -scheme "$SWIFT_PROJECT_NAME" -configuration Release SKIP_INSTALL=NO BUILD_LIBRARIES_FOR_DISTRIBUTION=YES CONFIGURATION_BUILD_DIR="$SWIFT_BUILD_ABSOLUTE_PATH"
#xcodebuild -sdk iphonesimulator -workspace "$SWIFT_PROJECT_NAME.xcworkspace" -scheme "$SWIFT_PROJECT_NAME" -configuration Debug SKIP_INSTALL=NO BUILD_LIBRARIES_FOR_DISTRIBUTION=YES CONFIGURATION_BUILD_DIR="$SWIFT_BUILD_ABSOLUTE_PATH"
#xcodebuild -sdk iphoneos -workspace "$SWIFT_PROJECT_NAME.xcworkspace" -scheme "$SWIFT_PROJECT_NAME" -configuration Release SKIP_INSTALL=NO BUILD_LIBRARIES_FOR_DISTRIBUTION=YES CONFIGURATION_BUILD_DIR="$SWIFT_BUILD_ABSOLUTE_PATH"
#xcodebuild -sdk iphoneos -workspace "$SWIFT_PROJECT_NAME.xcworkspace" -scheme "$SWIFT_PROJECT_NAME" -configuration Debug SKIP_INSTALL=NO BUILD_LIBRARIES_FOR_DISTRIBUTION=YES CONFIGURATION_BUILD_DIR="$SWIFT_BUILD_ABSOLUTE_PATH"
