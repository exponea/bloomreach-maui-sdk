...
SWIFT_PROJECT_NAME="BloomreachSDKMauiIOS"
...
#sharpie bind --sdk=iphoneos --output="./frameworks" --namespace="BloomreachSdkNativeiOS" --scope="$SWIFT_OUTPUT_PATH/$SWIFT_PROJECT_NAME.framework/Headers/" "$SWIFT_OUTPUT_PATH/$SWIFT_PROJECT_NAME.framework/Headers/$SWIFT_PROJECT_NAME-Swift.h"
